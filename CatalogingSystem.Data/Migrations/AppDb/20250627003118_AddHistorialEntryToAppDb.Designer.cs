...
namespace CatalogingSystem.Data.Migrations.AppDb
{
    ...
    [Migration("20250627003118_AddHistorialEntryToAppDb")]
    partial class AddHistorialEntryToAppDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatalogingSystem.Core.Entities.HistorialEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("ArchivoAdministrativoId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("AuditLogId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("GraphicDocumentationId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("ArchivoAdministrativoId");

                    b.HasIndex("AuditLogId");

                    b.HasIndex("GraphicDocumentationId");
            ...
            modelBuilder.Entity("CatalogingSystem.Core.Entities.HistorialEntry", b =>
                {
                    b.HasOne("CatalogingSystem.Core.Entities.ArchivoAdministrativo", null)
                        .WithMany("HistorialEntries")
                        .HasForeignKey("ArchivoAdministrativoId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CatalogingSystem.Core.Entities.AuditLog", "AuditLog")
                        .WithMany()
                        .HasForeignKey("AuditLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CatalogingSystem.Core.Entities.GraphicDocumentation", null)
                        .WithMany("HistorialEntries")
                        .HasForeignKey("GraphicDocumentationId")
                        .OnDelete(DeleteBehavior.Cascade);
